...
public class RPG_Game {
    ...
    public static void startGame() {
        Boss boss = new Boss(10000, 50, "Fatih");
        ...
        Witcher witcher = new Witcher(270, 0,"EMIL");
        Tor tor = new Tor(300,30,"BAYAMAN");
        Hero[] heroes = {warrior1, warrior2, doc, magic, berserk, assistant,witcher,tor};
